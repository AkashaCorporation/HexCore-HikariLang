...
pub fn builtin_signatures() -> HashMap<String, FunctionSig> {
    ...
    sigs.insert(
        ...
        FunctionSig {
            params: vec![
                Param {
                    name: "binary".into(),
                    type_: HKLType::Binary { format: None },
                },
                Param {
                    name: "hints".into(),
                    type_: HKLType::String_,
                },
            ],
    ...
    sigs.insert(
        ...
        FunctionSig {
            params: vec![
                ...
                Param {
                    name: "timeout".into(),
                    type_: HKLType::Int { width: Some(32) },
                },
            ],
    ...
    sigs.insert(
        ...
        FunctionSig {
            params: vec![
                ...
                Param {
                    name: "include".into(),
                    type_: HKLType::Array(Box::new(HKLType::String_)),
                },
            ],
    ...
    sigs.insert(
        "chacha_detection".into(),
        FunctionSig {
            params: vec![],
            returns: HKLType::Pattern {
                pattern_type: PatternType::HQL,
            },
        },
    );

    sigs.insert(
        "refcount_scanner".into(),
        FunctionSig {
            params: vec![],
            returns: HKLType::Pattern {
                pattern_type: PatternType::HQL,
    ...
    sigs.insert(
        ...
        FunctionSig {
            params: vec![
                Param {
                    name: "items".into(),
                    type_: HKLType::Array(Box::new(HKLType::Unknown)),
                },
                Param {
                    name: "predicate".into(),
                    type_: HKLType::Fn {
...
impl std::fmt::Display for HKLType {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            HKLType::Pattern { pattern_type } => {
                write!(f, "Pattern<{:?}>", pattern_type)
            }
